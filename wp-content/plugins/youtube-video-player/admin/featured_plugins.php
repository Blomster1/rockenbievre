	...
	public function controller_page(){
		$plugins_array=array(
            ...
            'facebook-comments'=>array(
						...
						'description'	=>	'Our Facebook comments plugin will help you to display Facebook Comments on your website. You can use Facebook Comments on pages/posts.'
						),							
			'facebook'=>array(
						...
						'description'	=>	'Our Facebook like box plugin will help you to display Facebook like box on your wesite, just add Facebook Like box widget into your sidebar or insert it into your website posts/pages and use it.'
						),
			'poll'=>array(
