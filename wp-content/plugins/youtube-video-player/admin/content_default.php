...
class youtube_embed_content_default{
	...
	?>
        ...
        <h2>YouTube Embed Pages/posts default Settings</h2>	
        ...
        <table class="wp-list-table widefat fixed posts youtube_settings_table" style="width: 640px; min-width:320px !important;table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>                     
                	<td>     
                    	Show related videos:<span class="pro_subtitle_span">Pro feature!</span> <span title="Set this option if you want to not show related videos after the YouTube video ends." class="desription_class">?</span>
                    </td>
                    <td class="radio_input">     
                ...
                <tr>
                 ...
                 <tr>
                    <td>     
                    	Autohide Parameters: <span title="Set this option if you need to Autohide Parameters" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                    <td>     
                    	Initial Volume Level: <span title="Choose Initial Volume for YouTube videos" class="desription_class">?</span>
                    </td>
                    <td>     
